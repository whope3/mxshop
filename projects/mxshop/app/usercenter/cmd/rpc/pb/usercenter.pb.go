...
func (x *SignOutReq) GetMobile() string {
	if x != nil {
		return x.Mobile
	}
	return ""
...
func (x *SignOutReq) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *SignOutResp) GetUid() int64 {
	if x != nil {
		return x.Uid
	}
	return 0
...
func (x *SignOutResp) GetUserName() string {
	if x != nil {
		return x.UserName
	}
	return ""
...
func (x *SignOutResp) GetPhoneNumber() string {
	if x != nil {
...
var file_usercenter_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0x54, 0x0a, 0x0a, 0x53, 0x69, 0x67, 0x6e, 0x4f, 0x75, 0x74, 0x52, 0x65, 0x71,
	...
	0x70, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x22, 0x5f, 0x0a, 0x0b, 0x53, 0x69, 0x67, 0x6e,
	0x4f, 0x75, 0x74, 0x52, 0x65, 0x73, 0x70, 0x12, 0x10, 0x0a, 0x03, 0x75, 0x69, 0x64, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x03, 0x52, 0x03, 0x75, 0x69, 0x64, 0x12, 0x1b, 0x0a, 0x09, 0x75, 0x73, 0x65,
	...
	0x6f, 0x6e, 0x65, 0x4e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x32, 0x33, 0x0a, 0x0b, 0x55, 0x73, 0x65,
	0x72, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x24, 0x0a, 0x07, 0x53, 0x69, 0x67, 0x6e,
	0x4f, 0x75, 0x74, 0x12, 0x0b, 0x2e, 0x53, 0x69, 0x67, 0x6e, 0x4f, 0x75, 0x74, 0x52, 0x65, 0x71,
	0x1a, 0x0c, 0x2e, 0x53, 0x69, 0x67, 0x6e, 0x4f, 0x75, 0x74, 0x52, 0x65, 0x73, 0x70, 0x42, 0x06,
...
var file_usercenter_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_usercenter_proto_goTypes = []any{
	(*SignOutReq)(nil),  // 0: SignOutReq
	(*SignOutResp)(nil), // 1: SignOutResp
}
var file_usercenter_proto_depIdxs = []int32{
	0, // 0: UserService.SignOut:input_type -> SignOutReq
	1, // 1: UserService.SignOut:output_type -> SignOutResp
